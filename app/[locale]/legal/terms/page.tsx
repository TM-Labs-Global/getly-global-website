      ...
      <div className="max-w-4xl mx-auto px-6 space-y-12">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 border border-[var(--line)] shadow-soft space-y-8 text-sm sm:text-base text-[var(--ink-soft)] leading-relaxed">
          <div className="space-y-3">
            <h2 className="text-xl font-bold text-[var(--navy)]">{t("terms.section1Title")}</h2>
            <p>{t("terms.section1Desc")}</p>
          </div>

          <div className="space-y-3">
            <h2 className="text-xl font-bold text-[var(--navy)]">{t("terms.section2Title")}</h2>
            <p>{t("terms.section2Desc")}</p>
          </div>

          <div className="space-y-3">
            <h2 className="text-xl font-bold text-[var(--navy)]">{t("terms.section3Title")}</h2>
